...
class ApiClient(object):
    ...
    def __call_api(
        ...
        if _preload_content:
            ...
            if response_types and response_data.status in response_types:
                response_type = response_types[response_data.status]
    ...
    def select_header_accept(self, accepts):
        ...
        accepts = [x + (';q=1' if x == 'application/json' else ';q=0.9') for x in accepts]
